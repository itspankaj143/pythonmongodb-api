...
client = MongoClient("mongodb+srv://pankaj1234kashyap:8CBHXU23ht5OgvwG@cluster0.lfu3n.mongodb.net/python-api?retryWrites=true&w=majority&appName=Cluster0", tlsAllowInvalidCertificates=True)
